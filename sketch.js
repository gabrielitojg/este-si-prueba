...
function preload(){
  ...
  //Precargar imagen del señor corriendo
  runner = loadAnimation("corre1.png","corre2.png","corre3.png", "corre4.png");
...
function setup() {
  ...
  carretera = createSprite(width/2,height/2,width,50);
...
function spawnObstacles(){
 if (frameCount % 60 === 0){
   var obstaculo = createSprite(1000,height-40,20,30 );
